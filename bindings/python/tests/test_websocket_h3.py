...
class TestWebSocketH3Api:
    def test_client_websocket_h3_returns_builder(self):
        ...
        assert isinstance(builder, warpsock.WebSocketH3Builder)
    ...
    def test_tunnel_event_class_shape(self):
        assert hasattr(warpsock.H3TunnelEvent, "kind")
        assert hasattr(warpsock.H3TunnelEvent, "data")
        assert hasattr(warpsock.H3TunnelEvent, "error")
        assert hasattr(warpsock.H3TunnelEvent, "last_stream_id")
        assert not hasattr(warpsock.H3TunnelEvent, "id")
